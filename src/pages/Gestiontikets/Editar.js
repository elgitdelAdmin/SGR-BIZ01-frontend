                    ...
                    />*/}
                        ...
                        <div className="field col-12" style={{ marginTop: -6 }}>
                          ...
                          <MultiSelectDefault
                            ...
                            optionValue="id"
                            disabled={!isAdmin && (!isGestorCuenta || (isGestorCuenta && persona?.empresa?.idGestor && (gestorCuenta?.find(g => g.id === persona.empresa.idGestor)?.idUser !== Number(window.localStorage.getItem("idUser")))))}
                          />
                        </div>
                      </div>
                    </div>
