...
import { convertirTiempoDecimal, excelFileToJSON, excelFileToJSONSheet } from "../../helpers/helpers";
...
const ImportarCurso = () => {
  ...
  const handleUpload = (e) => {
    ...
    excelFileToJSONSheet(e.files[0], 2, setListaBibliografia);
    excelFileToJSONSheet(e.files[0], 3, setListaUnidad);
    excelFileToJSONSheet(e.files[0], 4, setListaLeccion);
    excelFileToJSONSheet(e.files[0], 5, setListaMaterial);
    excelFileToJSONSheet(e.files[0], 6, setListaEvaluacion);
  };
  ...
  const handleCargar =()=>{
    ...
    try {
        ...
        let jsonImportar = JSON.stringify({ListaCurso,ListaDiseñador,ListaBibliografia,
  ...
  const horaTemplate = (rowData) => {
    return rowData.DURACION_INTRODUCCION ? convertirTiempoDecimal(rowData.DURACION_INTRODUCCION):"";
  };
          ...
          <TabView>
            <TabPanel header="Curso">
              <DatatableDefault value={listaCurso}>
                    ...
                    <Column field="VIDEO_INTRODUCCION" header="Video Introducción"></Column>
                    <Column field="DURACION_INTRODUCCION" header="Duración Introducción min."dataType="date" body={horaTemplate}></Column>
              </DatatableDefault>
            </TabPanel>
            ...
            <TabPanel header="Unidades">
              <DatatableDefault value={listaUnidad}>
                ...
                <Column field="LOGRO" header="Logro (DC + COMERCIAL - SEO)"></Column>
                <Column field="ARCHIVOS_DESCARGABLES" header="Archivos Descargables"></Column>
              </DatatableDefault>
            </TabPanel>
            <TabPanel header="Lecciones">
              <DatatableDefault value={listaLeccion}>
                ...
                <Column field="DURACION_TOTAL_LECCION" header="Duracion total de lección EN MINUTOS (aud + DC)" dataType="date" body={DuracionTotalTemplate}></Column>
              </DatatableDefault>
            </TabPanel>
            ...
            <TabPanel header="Evaluaciones">
              <DatatableDefault value={listaEvaluacion}>
                <Column field="NUMERO_UNIDAD" header="Número unidad"></Column>
                <Column field="NUMERO_PREGUNTA" header="Número pregunta"></Column>
                <Column field="PREGUNTA" header="Pregunta" style={{width:150}}></Column>
                <Column field="RECURSO_REGUNTA" header="Recurso pregunta"></Column>
                <Column field="TIPO_RECURSO_PREGUNTA" header="Tipo recurso pregunta"></Column>
                ...
                <Column field="OPCION_CORRECTA" header="Opción correcta"></Column>
                <Column field="IMAGEN_OPCION_1" header="Imagen opción 1"></Column>
                <Column field="IMAGEN_OPCION_2" header="Imagen opción 2"></Column>
                <Column field="IMAGEN_OPCION_3" header="Imagen opción 3"></Column>
                <Column field="IMAGEN_OPCION_4" header="Imagen opción 4"></Column>
                <Column field="IMAGEN_OPCION_5" header="Imagen opción 5"></Column>
                <Column field="FUENTE" header="Fuente" style={{width:250}}></Column>
              </DatatableDefault>
            </TabPanel>
          </TabView>
        </div>
