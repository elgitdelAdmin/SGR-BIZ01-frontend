...
const EditarPreguntas = () => {
    ...
    const schema = Yup.object().shape({
        idPreguntaTipo: Yup.string().required("Tipo de pregunta es un campo obligatorio"),
    ...
    return ( 
        <form onSubmit={formik.handleSubmit}>
            <div className="zv-editarPregunta" style={{paddingTop:16}}>
                    ...
                    <div className="p-fluid formgrid grid">
                        <div className="field col-12 md:col-6">
                            ...
                            <DropdownDefault type={"text"} 
                                ...
                                options={comboTipoPregunta} optionLabel="label" optionValue ="valor"
                                ></DropdownDefault>
                            <small className="p-error">{formik.touched.idPreguntaTipo && formik.errors.idPreguntaTipo}</small>
                ...
                <div className="zv-editarPregunta-footer" style={{display:"flex",gap:8}}>
                        <Boton label="Guardar cambios" style={{fontSize:12}} color="primary" type="submit" loading={formik.isSubmitting}></Boton>
                        {modoEdicion && <Boton label="Crear Respuesta" style={{fontSize:12}} color="secondary" type ="button"
